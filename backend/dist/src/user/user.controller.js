...
let UserController = class UserController {
    ...
    async verifyPassword(confirmationCode, body) {
...
__decorate([
    (0, common_1.Get)('confirm/:confirmationCode'),
    __param(0, (0, common_1.Param)('confirmationCode')),
    __metadata("design:type", Function),
...
__decorate([
    (0, common_1.Post)('verify-password/:confirmationCode'),
    __param(0, (0, common_1.Param)('confirmationCode')),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
